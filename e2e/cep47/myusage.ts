...
const test = async () => {
  ...
  console.log('... grant gatekeeper \n');

  const mintDeploy = await cep47.grant_gatekeeper(
    KEYS_USER.publicKey,
    MINT_ONE_PAYMENT_AMOUNT!,
    KEYS.publicKey,
    [KEYS]
  ...
  console.log("...... grantGatekeeper deploy hash: ", mintDeployHash);

  await getDeploy(NODE_ADDRESS!, mintDeployHash);
  console.log("...... Gatekeeper granted successfully");
