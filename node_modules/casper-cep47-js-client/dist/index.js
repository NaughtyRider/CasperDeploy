...
(function (CEP47Events) {
    ...
    CEP47Events["grant_gatekeeper"] = "grant_gatekeeper";
    CEP47Events["init"] = "init";
    CEP47Events["bid"] = "bid";
    ...
    if (value.body.DeployProcessed.execution_result.Success) {
        ...
        var cep47Events = transforms.reduce(function (acc, val) {
            if (val.transform.hasOwnProperty("WriteCLValue") &&
                ...
                if (clValue && clValue.clType().tag === casper_js_sdk_1.CLTypeTag.Map) {
                    var hash = clValue.get(casper_js_sdk_1.CLValueBuilder.string("contract_package_hash"));
                    var event = clValue.get(casper_js_sdk_1.CLValueBuilder.string("event_type"));
                    if (hash &&
                        ...
                        acc = __spreadArray(__spreadArray([], acc, true), [{ name: event.value(), clValue: clValue }], false);
                    }
                }
            }
            return acc;
...
var CEP47Client = /** @class */ (function () {
    function CEP47Client(nodeAddress, networkName) {
        ...
        this.deploy = new casper_js_sdk_1.DeployUtil.ExecutableDeployItem;
    }
    ...
    CEP47Client.prototype.setArgs = function (name, value) {
    ...
    CEP47Client.prototype.reserve_price = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contractClient.queryContractData(['reserve_price'])];
            });
        });
    };
    CEP47Client.prototype.get_start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contractClient.queryContractData(['start_time'])];
            });
        });
    };
    CEP47Client.prototype.get_end = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contractClient.queryContractData(['end_time'])];
            });
        });
    };
    CEP47Client.prototype.name = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contractClient.queryContractData(['name'])];
            });
        });
    };
    CEP47Client.prototype.symbol = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contractClient.queryContractData(['symbol'])];
            });
        });
    };
    CEP47Client.prototype.meta = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contractClient.queryContractData(['meta'])];
            });
        });
    };
    CEP47Client.prototype.totalSupply = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contractClient.queryContractData(['total_supply'])];
            });
        });
    };
    CEP47Client.prototype.balanceOf = function (account) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contractClient
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        maybeValue = result.value().unwrap();
                        return [2 /*return*/, "account-hash-".concat(Buffer.from(maybeValue.value().value()).toString("hex"))];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, fromCLMap(maybeValue)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contractClient.queryContractDictionary('owned_tokens_by_index', hex)];
                    case 1:
                        result = _a.sent();
                        maybeValue = result.value().unwrap();
                        return [2 /*return*/, maybeValue.value().toString()];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contractClient.queryContractDictionary('owned_indexes_by_token', hex)];
                    case 1:
                        result = _a.sent();
                        maybeValue = result.value().unwrap();
                        return [2 /*return*/, maybeValue.value().toString()];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contractClient.queryContractDictionary('allowances', hex)];
                    case 1:
                        result = _a.sent();
                        maybeValue = result.value().unwrap();
                        return [2 /*return*/, "account-hash-".concat(Buffer.from(maybeValue.value().value()).toString("hex"))];
    ...
    CEP47Client.prototype.approve = function (spender, ids, paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contractClient.callEntrypoint('approve', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    CEP47Client.prototype.mint = function (recipient, ids, metas, paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contractClient.callEntrypoint('mint', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    //nakul
    CEP47Client.prototype.grant_gatekeeper = function (gatekeeper, 
    //ids: string[],
    paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            var runtimeArgs;
            return __generator(this, function (_a) {
                runtimeArgs = casper_js_sdk_1.RuntimeArgs.fromMap({
                    gatekeeper: casper_js_sdk_1.CLValueBuilder.key(gatekeeper)
                ...
                return [2 /*return*/, this.contractClient.callEntrypoint('grant_gatekeeper', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    CEP47Client.prototype.init = function (AUCTION_PACKAGE_HASH, AUCTION_CONTRACT_HASH, 
    //ids: string[],
    paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            var runtimeArgs;
            return __generator(this, function (_a) {
                runtimeArgs = casper_js_sdk_1.RuntimeArgs.fromMap({
                    AUCTION_PACKAGE_HASH: casper_js_sdk_1.CLValueBuilder.string(AUCTION_PACKAGE_HASH.slice(5)),
                    AUCTION_CONTRACT_HASH: casper_js_sdk_1.CLValueBuilder.string(AUCTION_CONTRACT_HASH.slice(5))
                    //token_ids: CLValueBuilder.list(ids.map(id => CLValueBuilder.u256(id))),
                    // token_metas: CLValueBuilder.list(metas.map(meta => toCLMap(meta)))
                });
                return [2 /*return*/, this.contractClient.callEntrypoint('init', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    CEP47Client.prototype.bid = function (bid, bidpurse, 
    //ids: string[],
    paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            var runtimeArgs;
            return __generator(this, function (_a) {
                runtimeArgs = casper_js_sdk_1.RuntimeArgs.fromMap({
                    bid: casper_js_sdk_1.CLValueBuilder.u512(bid),
                    bid_purse: casper_js_sdk_1.CLURef.fromFormattedStr(bidpurse)
                    //token_ids: CLValueBuilder.list(ids.map(id => CLValueBuilder.u256(id))),
                    // token_metas: CLValueBuilder.list(metas.map(meta => toCLMap(meta)))
                });
                return [2 /*return*/, this.contractClient.callEntrypoint('bid', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    CEP47Client.prototype.get_bid = function ( 
        //ids: string[],
        paymentAmount, deploySender, keys) {
            return __awaiter(this, void 0, void 0, function () {
                var runtimeArgs;
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.contractClient.callEntrypoint('get_bid', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
                });
            });
        };
        CEP47Client.prototype.cancel_bid = function ( 
            //ids: string[],
            paymentAmount, deploySender, keys) {
                return __awaiter(this, void 0, void 0, function () {
                    var runtimeArgs;
                    return __generator(this, function (_a) {
                        ...
                        return [2 /*return*/, this.contractClient.callEntrypoint('cancel_bid', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
                    });
                });
            };

            CEP47Client.prototype.cancel_auction = function ( 
                //ids: string[],
                paymentAmount, deploySender, keys) {
                    return __awaiter(this, void 0, void 0, function () {
                        var runtimeArgs;
                        return __generator(this, function (_a) {
                            ...
                            return [2 /*return*/, this.contractClient.callEntrypoint('cancel_auction', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
                        });
                    });
                };

        CEP47Client.prototype.finalize = function ( 
            //ids: string[],
            paymentAmount, deploySender, keys) {
                return __awaiter(this, void 0, void 0, function () {
                    var runtimeArgs;
                    return __generator(this, function (_a) {
                        ...
                        return [2 /*return*/, this.contractClient.callEntrypoint('finalize', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
                    });
                });
            };
    //nakul end
    CEP47Client.prototype.mintCopies = function (recipient, ids, meta, count, paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contractClient.callEntrypoint('mint_copies', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    CEP47Client.prototype.burn = function (owner, ids, paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contractClient.callEntrypoint('burn', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    CEP47Client.prototype.transferFrom = function (recipient, owner, ids, paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contractClient.callEntrypoint('transfer_from', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    CEP47Client.prototype.transfer = function (recipient, ids, paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contractClient.callEntrypoint('transfer', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    CEP47Client.prototype.updateTokenMeta = function (id, meta, paymentAmount, deploySender, keys) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contractClient.callEntrypoint('update_token_meta', runtimeArgs, deploySender, this.networkName, paymentAmount, keys)];
            });
        });
    };
    return CEP47Client;
